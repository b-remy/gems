...
def gen_obs(NUM_GAL, NOISE_LEVEL, STAMP_SIZE, PIXEL_SCALE, max_hlr=0.5, max_flux=0, g1=None, g2=None, return_only_theta_obs=False):
    ...
    ims_convolved = convolve_fourier(im_sheared, imkpsfs)
    
    obs = ims_convolved + tf.random_normal([1, NUM_GAL, STAMP_SIZE, STAMP_SIZE]) * NOISE_LEVEL
...
def gen_batch_obs(batch_size, NUM_GAL, NOISE_LEVEL, STAMP_SIZE, PIXEL_SCALE, max_hlr=0.6, max_flux=150, g1=None, g2=None, return_only_theta_obs=False):
    ...
    obs = ims_convolved + tf.random_normal([batch_size, NUM_GAL, STAMP_SIZE, STAMP_SIZE]) * NOISE_LEVEL
...
def gen_obs_no_pairs(NUM_GAL, NOISE_LEVEL, STAMP_SIZE, PIXEL_SCALE, max_hlr=0.5, max_flux=0, g1=None, g2=None, return_only_theta_obs=False):
    ...
    z_samples = prior_z.sample(NUM_GAL)
    ...
    ims_tot = tf.reshape(reconstruction, (1, NUM_GAL, STAMP_SIZE, STAMP_SIZE))
